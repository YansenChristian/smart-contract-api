...
return [
   ...
   'GRANT_URL'                => 'https://kongdev.ralali.com/oauth/v1/grant',
   'ACCESS_URL'               => 'https://kongdev.ralali.com/oauth/v1/login',
   'RETOKEN_URL'              => 'https://kongdev.ralali.com/oauth/v1/retoken',
    'LOGOUT_URL'              => 'https://kongdev.ralali.com/oauth/v1/logout',
    'TOKEN_STATUS_URL'        => 'https://kongdev.ralali.com/oauth/v1/token_status',
    'GRANT_STATUS_URL'        => 'https://kongdev.ralali.com/oauth/v1/grant_status',
   'API_URL'                  => 'https://apidev.ralali.com/api/v1/',
   'API_GLOBAL_URL'           => 'https://apidev.ralali.com/',
   'API_USERNAME'             => NULL,
   'API_PASSWORD'             => NULL,

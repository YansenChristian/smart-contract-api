...
<div id="content" style="padding:20px 20px;">
    <div style="text-align: center;margin: 20px 0 25px">
        Dear <b>{{$name}}</b> Pesanan anda dengan nomor order
    ...
    <div style="font-weight:bold;color:#000000;text-align:center;margin-top:20px;">Pembayaran Anda telah dikonfirmasi oleh sistem.<br>

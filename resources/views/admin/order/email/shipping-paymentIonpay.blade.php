...
<div id="content" style="padding:20px 20px;">
    <div style="text-align: center;margin: 20px 0 25px">
        Dear <b>{{$name}}</b>,<br/> Pesanan anda dengan nomor order
    ...
    <table style="margin: 0 20px auto;border-radius: 3px;border-spacing: 0px;width: 95%;">
        ...
        <tr>
            ...
            <td style="border-right: 1px solid #ccc">
                <div style="font-weight: bold">Sub Total</div>{{ displayNumericWithoutRp( ($data['price']*$data['product_quantity'])+$data['shipping_price'] ) }}
    ...
    <div style="font-weight:bold;color:#000000;text-align:center;margin-top:20px;">Pembayaran Anda telah dikonfirmasi oleh sistem IONPAY.<br>
        Pesanan Anda akan segera kami proses ke penjual. Terima Kasih.
    </div>
